...
// Modular arithmetic (File #6)
extern u16 ml_kem_barrett_reduce(u32 a);
extern u16 ml_kem_multipl_mod(u16 a, u16 b);
extern u16 ml_kem_add_mod(u16 a, u16 b);
extern u16 ml_kem_sub_mod(u16 a, u16 b);

// SHA3 wrappers (File #7)
...
// Keccak-f[1600] permutation (File #9)
extern void keccak_f1600_ct(u64 state[25]);

// Decapsulation pool API (File #10)
...
extern u16 ml_kem_ct_sub_if_ge(u16 x);                                           // Status: not yet tested.... file: math_operations.c
...
extern u8 ml_kem_decode1_bit(u16 w);                                             // Status: tested.... file: ml_kem_decrypt.c
